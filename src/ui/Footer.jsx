...
const SocialIcon = ({ platform }) => {
    const icons = {
        GitHub: (
            <a href="https://github.com/kareem1207/Aizy" target="_blank">
        ...
        X: (
            <a href="https://x.com/KareemShaik1207" target="_blank">
            <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current">
        ...
        Instagram: (
            <a href="https://www.instagram.com/annieeee_029/" target="_blank">
            <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current">
