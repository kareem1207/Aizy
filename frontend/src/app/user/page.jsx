      ...
      if (userData.id) {
        navigator.clipboard.writeText(userData.id)
          ...
          .catch(err => {
            ...
            setMessage({ type: 'error', text: 'Failed to copy ID.' });
          ...
          <div className="mt-8">
            ...
            <div className="bg-gradient-to-r from-[#3c6ca8]/10 to-[#3c6ca8]/5 p-5 rounded-lg shadow-sm border border-[#3c6ca8]/20 hover:shadow-md transition-shadow">
              ...
              <button
                ...
                className="p-1.5 rounded-md hover:bg-[#3c6ca8]/20 transition-colors"
                title="Copy ID"
              >
                {copied ? (
               ...
               {copied && <span className="text-xs text-green-500 mt-1">Copied!</span>}
            </div>
            </div>
          </div>
          )}
