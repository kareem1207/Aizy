...
const SocialIcon = ({ platform }) => {
    const icons = {
        GitHub: {
            href: "https://github.com/kareem1207/Aizy",
            icon: (
        ...
        X: {
            href: "https://x.com/KareemShaik1207",
            icon: (
                <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current">
        ...
        Instagram: {
            href: "https://www.instagram.com/annieeee_029/",
            icon: (
                <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current">
    ...
    const socialData = icons[platform];
    return (
        <Link 
...
export const Footer = () => {
    // Get year once when component mounts
