          ...
          <div className="relative">
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm text-gray-500">{item.stock !=0 ? "In Stock" : "Out of Stock"}</span>
                </div>
                ...
                <div>
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="w-full bg-[#3c6ca8] hover:bg-[#2c5f8c] text-white py-2 rounded-lg font-semibold transition-colors"
                    >
                      Add to Cart
                    </motion.button>
                  </div>
